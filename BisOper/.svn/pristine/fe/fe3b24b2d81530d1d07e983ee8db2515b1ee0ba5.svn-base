...
function stringParser(cellValue, rowObject, options){
	var str = cellValue.replace(".0", "");
	return str;
}
...
//	});
	...
	$(".btn_regi").click(function(){
		showConfirmDlg("등록하시겠습니까?", registerPenalty);
	});
