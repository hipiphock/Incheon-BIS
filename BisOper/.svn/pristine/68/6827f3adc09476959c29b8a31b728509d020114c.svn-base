...
<script src="./js/v05/v0505.js"></script>
</head>
                	...
                	<div class="contenBox allBody">
                		...
                		<div class="conbottom v0505bottom">
                			<table>
                				<tr>
                					<th>면허버스 수</th>
                					<td><span id="lcnt">0</span> 대</td>
                					<th>1회운행시간</th>
                					<td><span id="runtm">0분 0초</span></td>
                					<th>시점</th>
                					<td><span id="snm">-</span></td>
                					<th>종점</th>
                					<td><span id="enm">-</span></td>
                					<th>노선길이</th>
                					<td><span id ="routelen">0</span></td>
                					<th>굴곡도</th>
                					<td><span id="routecurv">0</span></td>
                				</tr>
                			</table>
                		</div>
