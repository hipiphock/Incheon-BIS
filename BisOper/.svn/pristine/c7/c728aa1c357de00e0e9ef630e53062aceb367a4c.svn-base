			...
			<div class="big_all_body_con">
				<div class="nosun_conbody">
					<div class="subcon_con2">
						<div class="base_left nosun_left">
							<!--왼쪽-->
							<!-- 검색 -->
							<div class="no_serch">
								<div class="n_btn_box">
									<input id="input_search" type="text" class="in bit_in_text"
										name="ID" placeholder="노선명 검색"> <span><img
										id="btn_search" class="sub_serch_btn"
										src="./images/serch_gray.png" alt="검색버튼"></span>
								</div>
								<a id="btn_clear" href="javascript:void(0);"
									class="serch_clear6">clear</a>
							</div>
							<!-- 검색 끝-->
							<div class="base_left_chart_body nosun_body">
								<div class="main_chart">
									<!--<!--.main_chart 사이즈 [ width: 100%; height:100%;]-->
									<table id="route_list"></table>
								</div>
							</div>
							<!--왼쪽 표-->
						</div>
						<div class="base_right nosun_right"
							style="background-color: #fff;">
							<!--오른쪽-->
							<div class="nosun_first">
								<div class="nosun_title1">
									<p>
										<span id="route_num">-</span> <span></span>
									</p>
									<p class="t1">
										( 전체: <span id="totalCnt">0</span> 종료: <span id="stopCnt">0</span>
										정상: <span id="normalCnt">0</span> 공차: <span id="emptyCnt">0</span>
										돌발: <span id="inciCnt">0</span> 노선이탈: <span id="awayCnt">0</span>
										임의지연: <span id="delayCnt">0</span> )
									</p>
								</div>
