...
<script src="./js/v07/v0701.js"></script>
                	...
                	<div class="contenBox allBody">
                		...
                		<div class="conleft v0701top">
							...
							<div class="conten con2">
                				<table>
                					<tr>
                						<th><label><input type="checkbox" class="checkBox" id="route_check"> 노선버전</label></th>
                						<td><input type="number" value="1" min="1" id="route_ver"></td>
                						<th><label><input type="checkbox" class="checkBox" id="oper_check"> 운영버전</label></th>
                						<td><input type="number" value="1" min="1" id="oper_ver"></td>
                						<th><label><input type="checkbox" class="checkBox" id="GIS_check"> GIS버전</label></th>
                						<td><input type="number" value="1" min="1" id="GIS_ver"></td>
                						<th>적용일시</th>
                						<td><input type="date" class="in145" id="apply_date"><input type="number" class="in90" min=0 max=23 id="apply_time"></td>
                						<td><label style="color: #ba0202; font-weight: bold;"><input type="checkbox" class="checkBox" id="transmit_check"> 전송확인</label></td>
                					</tr>
                				</table>
                				<button class="btn" id="btn_transmit"><img src="./images/icon_ok.png" alt="" >전송</button>
                			</div>
                		</div>
                		...
                		<div class="conbottom v0701bottom1">
                			...
                			<div class="conten">
                    			<div class="main_chart">
                    				<table id="bottom_left_table"></table>
                    			</div>
                    		</div>
                		...
                		<div class="conbottom v0701bottom2">
                			...
                			<div class="conten">
                    			<div class="main_chart">
                    				<table id="bottom_right_table"></table>
                    			</div>
                    		</div>
