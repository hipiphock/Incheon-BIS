...
<body>
	...
	<div class="wrap1">
            <header class="pop_title">
                <h2>시설물상태감시/제어 - 정류소안내기 상태정보 조회/제어</h2>
            </header>
            ...
            <article class="contenWrap">
				...
				<section class="serchBox">
                    <table class="top1 v0605">
                         <tr>
                            ...
                            <td><label><input type="checkbox" class="checkBox">전체감시</label><input type="number" class="in50"></td>
                            <th>안내기유형</th>
                            <td>
                              	<select>
                              		<option>전체</option>
                ...
                <section class="bodytBox towdep">
                	<div class="contenBox allBody v0605top">
						<div class="sub_title">
                			<h3>통합정류소안내기 상태정보</h3>
