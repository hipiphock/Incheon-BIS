...
<script src="./js/v06/v0601.js"></script>
				...
				<section class="serchBox">
                    <table class="top1 v0601">
                         <tr>
                            ...
                            <th>단말기ID</th>
                            <td> <input type="search" id="input2">  
                            </td>
                            <th>단말기<br>시리얼번호</th>
                            <td> <input type="search" id="input3">    
                            </td>
                            <th>사용여부</th>
                            <td><select id="use_option">
                              		<option value="-1">전체</option>
                	...
                	<div class="contenBox allBody">
                		...
                		<div class="conright v0601Right">
                			...
                			<table class="chart v0601Chart">
                				<tr>
                					<th>차량단말기ID</th>
                					<td><input type="text" id="input_mdtid" readonly></td>
                					<th>시설물ID</th>
                					<td><input type="text" id="input_facilid" readonly></td>
                				</tr>
                				<tr>
                					<th>차량등록번호</th>
                					<td><select id="select_carregno">
                              				<option>미설치</option>
                              			</select>
                              		</td>
                					<th>IP주소</th>
                				...
                				<tr>
                					<th>단말기<br>시리얼번호</th>
                					<td><input type="text" id="input_macaddr"></td>
                					<th>모뎀<br>시리얼번호</th>
                					<td><input type="text" id="input_modem_serialno"></td>
                				</tr>
                				<tr>
                					<th>설치위치</th>
                					<td colspan="3"><input type="text" class="in305" id="input_installloc"></td>
                				</tr>
                				<tr>
                					<th>사용여부</th>
                					...
                					<th>사용종료일시</th>
                					<td><input type="datetime" id="input_use_enddt"></td>
                				</tr>
                				<tr>
                					<th>비고</th>
                        	...
                        	<div class="bottom_btn bottomRight">
                        		<ul class="bottomBtn3">
                        			...
                        			<li><a href="javascript:void(0);" id="btn_modify" class="disabled">수정</a></li>
                        		</ul>
                        	</div>
                		</div>
