...
var models = [
              ...
              {label:"차고지명", 		name:"garagenm", 		index:"garagenm",		width: "80", 	align:"center", sorttype:"text", type:"S"},
              {label:"모뎀시리얼번호", 	name:"modem_serialno", 	index:"modem_serialno",	width: "80", 	align:"center", sorttype:"text", type:"I"},
              {label:"모델명", 		name:"modelnm", 		index:"modelnm",		width: "110", 	align:"center", sorttype:"text", type:"I"},
              ...
              {label:"비고", 			name:"descr", 			index:"descr",		 	width: "300", 	align:"center", sorttype:"text", type:"I"},
...
var models2 = [
               ...
               {label:"단말기용도유형", 	name:"tp", 				index:"tp",		 		width: "100", 	align:"center", sorttype:"text", type:"I"},
               ...
               {label:"설치일자", 		name:"installdt", 		index:"installdt",		width: "70", 	align:"center", sorttype:"text", type:"I"},
               {label:"유지보수기관", 	name:"orgnm", 			index:"orgnm",		 	width: "110", 	align:"center", sorttype:"text", type:"I"},
               {label:"사용여부", 		name:"useyn", 			index:"useyn",		 	width: "70", 	align:"center", sorttype:"text", type:"I"},
