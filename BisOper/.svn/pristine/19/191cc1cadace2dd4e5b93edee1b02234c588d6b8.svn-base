...
public class TbDmhTmspaceVO {
	private String evt_occurdt;			//	date				yes		1	
	private String busid;				//	number(9,0)			yes		2	
	private String evttpcd;				//	varchar2(2 byte)	yes		3	
	private String evtsubtpcd;			//	varchar2(1 byte)	yes	0	4	
	...
	private String msgseq;				//	number(10,0)		yes		34
	
	//	selectViolentOperHistList
