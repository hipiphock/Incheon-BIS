...
public class CtlrBUS {
	 ...
	 */
	@RequestMapping(value = "/selectWirelessUpgrade.do")
    public ModelAndView selectWirelessUpgrade(Model model, HttpServletRequest request,
    		@RequestParam(value= "compid", required=false, defaultValue="") String compid,
    		@RequestParam(value= "routeid", required= false, defaultValue="") String routeid,
    		@RequestParam(value="carregno", required=false, defaultValue="") String carregno,
    		@RequestParam(value="detail", required=false, defaultValue="") String detail,
    		@RequestParam(value="ver", required=false, defaultValue="") String ver,
        ...
        try {
        	...
        	List<TbAdmBusVO> resultList = busService.selectWirelessUpgrade(vo);	   
        	resultMap.put("resultList", resultList);
		} catch (Exception e) {
			logger.error("##selectWirelessUpgrade exception " + e.toString());
		}
        mv.addAllObjects(resultMap);
        mv.setViewName("jsonView");
        return mv;
	 ...
	 */
	@RequestMapping(value = "/selectMdtUpgrade.do")
    public ModelAndView selectMdtUpgrade(Model model, HttpServletRequest request,
        ...
        try {
        	TbAdmBusVO vo = new TbAdmBusVO();
        	vo.setMdtid(mdtid);        	
        	List<TbAdmBusVO> resultList = busService.selectMdtUpgrade(vo);	   
        	resultMap.put("resultList", resultList);
		} catch (Exception e) {
			logger.error("##selectMdtUpgrade exception " + e.toString());
		}
        mv.addAllObjects(resultMap);
        mv.setViewName("jsonView");
        return mv;
	 ...
	 * @return
	 */
	@RequestMapping(value = "/selectSearchPermList.do")
	public ModelAndView selectSearchPermList(Model model, HttpServletRequest request, TbAdmBusVO vo) {
		ModelAndView mv = new ModelAndView();

		Map<String, List<TbAdmBusVO>> resultMap = new HashMap<String, List<TbAdmBusVO>>();		
		try {
			List<TbAdmBusVO> resultList = busService.selectSearchPermList(vo);
			
			resultMap.put("resultList", resultList);
			
			logger.debug("##selectSearchPermList resultList " + resultList.size());
		} catch (Exception e) {
			logger.error("##selectSearchPermList exception " +  e.toString());
		}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/selectOneDayBusRunRecList.do")
	public ModelAndView selectOneDayBusRunRecList(Model model, HttpServletRequest request, TbDmhBusrunrecVO vo) {
		ModelAndView mv = new ModelAndView();

		Map<String, List<TbDmhBusrunrecVO>> resultMap = new HashMap<String, List<TbDmhBusrunrecVO>>();		
		try {
			List<TbDmhBusrunrecVO> resultList = busService.selectOneDayBusRunRecList(vo);
			
			resultMap.put("resultList", resultList);
			
			logger.debug("##selectOneDayBusRunRecList resultList " + resultList.size());
		} catch (Exception e) {
			logger.error("##selectOneDayBusRunRecList exception " +  e.toString());
		}
