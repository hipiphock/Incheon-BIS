...
public class BodyChangeParamExt {
	...
	public BodyChangeParamExt(int nCount ) {
	...
	public void sendPacket(UdpClient client) {
		...
		bitBuffer.put(BUSINFO_FONT_LED);
		bitBuffer.put(BUSINFO_COLOR_LED);
		bitBuffer.put(FAN_TEMP_LCD);
		bitBuffer.put(HEATER_TEMP_LCD);
