...
public class SystemDAO {
     ...
     */
    public List<TbOmcMdtfileregVO> selectUptodateVer(TbOmcMdtfileregVO vo) throws SQLException {
    	return sqlSession.selectList("SYSTEM.selectUptodateVer", vo);
    }
    
    /**
     *무선업그레이드관리(lg) - 무선업그레이드 전송 (v0701)
     */
    public int updateUptodateVer(TbOmcMdtfileregVO vo) throws SQLException {
    	return sqlSession.update("SYSTEM.updateUptodateVer", vo);
    }
    
    /**
     *무선업그레이드관리(lg) - 무선업그레이드 전송 신규등록 (v0701)
     */
    public int insertUptodateVer(TbOmcMdtfileregVO vo) throws SQLException {
    	return sqlSession.update("SYSTEM.insertUptodateVer", vo);
    }
