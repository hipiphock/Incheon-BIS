...
public class EvaluationDAO {
	...
	public List<TbDmsBuscrowdVO> selectStopColumn(TbDmsBuscrowdVO vo) throws SQLException{
		return sqlSession.selectList("EVALUATION.selectStopColumn", vo);
	}

	public List<TbDmsBuscrowdVO> selectCongestionStatistics(TbDmsBuscrowdVO vo) throws SQLException{
		return sqlSession.selectList("EVALUATION.selectCongestionStatistics", vo);
	}
}
