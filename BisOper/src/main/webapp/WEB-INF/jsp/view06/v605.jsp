...
<script src="./js/v06/v605.js"></script>
                    ...
                    <div class="two_serch_left">
                        <table class="two_serch"  border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="315px">
                                	<input type="text" class="in in_text_b serch_box_shot" readonly="readonly" id="input_stop_name">
                                    ...
                                    <div class="serch_check5"><label><input type="checkbox" name="check_research" class="check" id="check_detail">결과검색</label></div>
                                </td>
                            </tr>
                        </table>
                    </div>
                ...
                <div class="sistem_conbody">
                    ...
                    <div class="subcon_con3">
                        <div class="main_chart"><!--<!--.main_chart 사이즈 [ width: 100%; height:100%;]-->
                       		<table id="bit_earlyConn_list"></table>
                        </div>
                    </div>
                </div>
                <!--내용끝-->
