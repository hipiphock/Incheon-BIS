...
<script src="./js/v10/v1004.js"></script>
</head>
	...
	<div class="wrap1">
            ...
            <article class="contenWrap">
				...
				<section class="serchBox">
                    <table class="top1 v1004">
                         <tr>
							<th>권역코드</th>
                            <td>
                              	<select id="sel_areacd">
                					<option>전체</option>
                              	</select>
							</td>
                            <th>광역도시명</th>
                            <td>
                              	<select id="sel_gareanm">
                					<option>전체</option>
                              	</select>
							</td>
							<th>시군구명</th>
                            <td><input type="text" id="inp_areanm"></td>
                         </tr>
                    </table>
