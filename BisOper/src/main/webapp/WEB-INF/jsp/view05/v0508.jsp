...
<script src="./js/v05/v0508.js"></script>
</head>
            ...
            <article class="contenWrap">
				...
				<section class="serchBox">
                    <table class="top1 v0508">
                         <tr>
                         	<td><label><input type="checkbox" class="checkBox" id="chk_all_search">전체검색</label></td>
							<th>마스터적용일자</th>
                ...
                <section class="bodytBox towdep">
                	<div class="contenBox allBody">
                		...
                		<div class="conleft v0508Left">
                			<div class="sub_title">
                				<h3>노선버전 검색결과 <span id="list_cnt">0</span> 건</h3>
                			</div>
                		...
                		<div class="conright v0508Right">
                			...
                			<table class="chart v0508Chart">
                				<tr>
                					<th>Master 적용일자</th>
                					<td>
                						<input type="text" class="in180" id="input_masterdate">
                						<label><input type="checkbox" class="checkBox" id="chk_mdateyn">미입력</label>
                              		</td>
                				</tr>
                				<tr>
                					<th>노선번호</th>
                					<td><input type="text" id="input_route"></td>
                				</tr>
                				<tr>
                					<th>CSV 버전</th>
                					<td><input type="number" id="input_csvver"></td>
                				</tr>
                				<tr>
                					<th>GIS 버전</th>
                					<td><input type="number" id="input_gisver"></td>
                				</tr>
                				<tr>
                					<th>수정내용</th>
                					<td><input type="text" id="input_modifycont"></td>
                				</tr>
                				<tr>
                					<th>비고</th>
                				...
                				<tr>
                					<th>업데이트 파일</th>
                					<td><input type="text" id="input_updatefile"></td>
                				</tr>
                			</table>
                        	...
                        	<div class="bottom_btn bottomRight">
                        		<ul class="bottomBtn5">
                        			...
                        			<li><a href="javascript:void(0);" id="btn_delete" class="">삭제</a></li><!-- 비활성일 시 disabled 추가, 활성일 시 틀래스 삭제-->
