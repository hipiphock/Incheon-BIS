...
<script src="./js/v05/v514.js"></script>


</head>

<body>
	<input type="hidden" id="view_attr" value="BMS-V-510">

        <div class="big_wrap pop">
            <div class="pop_title2">
                <h2>BIT관리 - BIT 상태 조회</h2>
            </div>
            ...
            <div class="big_all_body_con">
                    ...
                    <div class="two_serch_left">
                        <table class="two_serch"  border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td>
                                	<input type="text" class="in in_text_b serch_box_shot list_265" id="input_stop_name" placeholder = "BIT아이디, 단축아이디, 정류장명">
                ...
                <div class="sistem_conbody">
                    <p class="serch_number">검색 결과 <span id="list_count">2</span></p>
                    <div class="subcon_con3">
                        <div class="main_chart"><!--<!--.main_chart 사이즈 [ width: 100%; height:100%;]-->
                        	<table id="bit_state_list"></table>
                        </div>
                    </div>
                </div>
                <!--내용끝-->
