...
<script src="./js/v05/v0520.js"></script>
	...
	<div class="wrap1">
            ...
            <article class="contenWrap">
				...
				<section class="serchBox">
                    <table class="top1 v0520">
                         <tr>
							<th>사업구분</th>
                            <td><select id="sel_projecttpcd">
                					<option>전체</option>
                              	</select>
                            </td>
							<th>안내기ID</th>
                            <td><input type="text" id="inp_bitid"></td>
							<th>정류소명</th>
                           <td><input type="text" id="inp_bstopnm"></td>
							<th>안내기유형</th>
                            <td>
                              	<select id="sel_bittpcd">
                					<option>전체</option>
                              	</select>
							</td>
                         </tr>
