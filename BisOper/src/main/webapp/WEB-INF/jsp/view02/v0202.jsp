...
<script src="./js/v02/v0202.js"></script>
                ...
                <section class="bodytBox towdep">
                	<div class="contenBox allBody">
                		...
                		<div class="conright v0202Right">
                			...
                			<!-- 선택버스노선 정류소 소통정보 시작 -->
                			<div class="conten con1">
                    			<div class="main_chart" id="dispatch_follow_chart">
                    				<table id="dispatch_follow_list"></table>
                    			</div>
                    		</div>
                		...
                		<!-- 아래 -->
                		<div class="conbottom v0202bottom">
                			<div class="sub_title">
                				<h3>선택노선정보</h3>
                			</div>
                			...
                			<!-- 선택버스노선 정류소 소통정보 시작 -->
                			<div class="conten">
                    			<div class="main_chart" id="selected_route_chart">
                    				<table id="selected_route_info"></table>
                    			</div>
                    		</div>
