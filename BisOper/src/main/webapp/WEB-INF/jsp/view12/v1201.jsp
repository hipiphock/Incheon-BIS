...
<script src="./js/v12/v1201.js"></script>
</head>
                ...
                <section class="bodytBox towdep">
                	<div class="contenBox allBody">
                		...
                		<div class="conright v1201Right">
                			...
                			<div class="conten con1">
                    			<div class="main_chart">
                    				<div id="container" style="min-width: 940px; height: 230px; margin: 0 auto"></div>
                    			</div>
                    		</div>
                		...
                		<!-- 아래 -->
                		<div class="conbottom v1201bottom">
                			<div class="sub_title">
                				<h3><span id="detail_title">차량단말기</span> 장애현황 <span id="detail_cnt">0</span>건</h3>
                			</div>
