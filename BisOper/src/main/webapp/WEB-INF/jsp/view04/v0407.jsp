...
<script src="./js/v04/v0407.js"></script>
            ...
            <article class="contenWrap">
				...
				<section class="serchBox">
                    <table class="top1 v0407">
                         <tr>
                            ...
                            <th>기간</th>
                            <td>
                              <input type="date" class="in180" id="start_date"> ~
                              <input type="date" class="in180" id="end_date">
							</td>
							<th>버스회사</th>
                            <td>
                ...
                <section class="bodytBox towdep">
                	<div class="contenBox allBody">
                		...
                		<!-- 아래 -->
                		<div class="conbottom v0407bottom">
                			<div class="sub_title">
                				<h3>운행정시성통계조회</h3>
                			</div>
