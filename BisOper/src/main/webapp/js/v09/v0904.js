...
var model = [
	{label:"전송일시",		name:"snddt",		index:"snddt",			width:"140",	align:"center",		sorttype:"text"},
	{label:"전송자명",		name:"usernm",		index:"usernm",			width:"100",	align:"center",		sorttype:"text"},
	...
	{label:"단말기ID",	name:"mdtid",		index:"mdtid",			width:"60",		align:"center",		sorttype:"text"},
	{label:"메시지유형",	name:"msgtype",		index:"msgtype",		width:"80",		align:"center",		sorttype:"text"},
	{label:"전송대상",		name:"msgtarget",	index:"msgtarget",		width:"80",		align:"center",		sorttype:"text"},
	{label:"메시지내용",	name:"msgcontent",	index:"msgcontent",		width:"490",	align:"left",		sorttype:"text"},
	{label:"전송결과",		name:"sndrsltcd",	index:"sndrsltcd",		width:"80",		align:"center",		sorttype:"text"}
];
