...
var models = [
              ...
              {label:"단말기시리얼번호",	name:"macaddr", 		index:"macaddr",		 	width: "90", 	align:"center", sorttype:"text", type:"I"},
              {label:"모뎀시리얼번호", 	name:"modem_serialno", 	index:"modem_serialno",	 	width: "90", 	align:"center", sorttype:"text", type:"I"},
              {label:"설치버스회사", 		name:"compnm", 			index:"compnm",		 		width: "70", 	align:"center", sorttype:"text"},
              {label:"설치차량번호", 		name:"carregno", 		index:"carregno",		 	width: "75", 	align:"center", sorttype:"text"},
              ...
              {label:"설치위치", 		name:"installloc", 		index:"installloc",		 	width: "80", 	align:"center", sorttype:"text", type:"I"},
              {label:"구매일", 		name:"purchdt", 		index:"purchdt",		 	width: "70", 	align:"center", sorttype:"text", type:"D"},
              {label:"비고", 			name:"descr", 			index:"descr",		 		width: "120", 	align:"center", sorttype:"text", type:"I"},
