...
<script src="./js/v06/v616.js"></script>
		...
		<div class="pop_title2">
            ...
            <div class="big_all_body_con">
                ...
                <div class="sub_top_btn">
                    <ul>
                        <li><a id="btn_excel1" href="javascript:void(0);"><img src="./images/btn_big_save.png"><p>운행회차</p></a></li>
                ...
                <div class="bit_conbody">
                	<div class="top_title">
                		<p id="search_count">운행회차 검색</p>
                	</div>
                	<div class="e614_top_title">
                		<p id="search_count2">정류소별 운행이력 검색</p>
                	</div>
                    <div class="subcon_con3">
                    	<div class="subcon2_left e614_left">
                            ...
                            <div class="serch_check"><label><input id="check_detail" type="checkbox" name="check" class="check">버스포함</label></div> -->
                            <!-- 검색추가부분 끝 -->	
                            <div class="base_left_chart_body" style="top:0; border-top: 0;">
