...
<script src="./js/v03/v0301.js"></script>
                    ...
                    <div class="subcon_con3">
                    	...
                    	<div class="sms2">
                    		<div class="sms2_con_left">
                    			<p class="sms2_serch_number">메세지폼 <span id="list_count2"></span>건</p>
                    		...
                    		<div class="sms2_con_right">
                    			...
                    			<div class="sms2_con_right_left">
                    				...
                    				<div class="r2_btn">
                    					<ul>
                    						<li><a id="btn_obj_add"><img src="./images/icon_plus.png">객체추가</a></li>
                    						<li><a id="btn_obj_del">객체삭제</a></li>
                    						<li><a id="btn_obj_last">마지막줄 추가</a></li>
                    					</ul>
                    				</div>
                    			</div>
