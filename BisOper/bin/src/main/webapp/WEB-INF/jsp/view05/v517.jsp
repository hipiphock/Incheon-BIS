...
<script type="text/javascript" src="./js/v05/v517.js"></script>
            ...
            <div class="big_all_body_con">
                ...
                <div class="bit_conbody">
                    ...
                    <div class="subcon_con3" style="top:8px;">
                    	<p class="serch_number serch_number_left sub_title title1">안내기 검색 결과 <span id="list_count1">100</span>건</p>
                    	<div class="file_left">
                        	...
                        	<div class="subcon_left_btn">
                        		<ul>
                        			<li><a href="javascript:void(0);" id="btn_req_download"><img src="./images/icon_ok.png" alt="">다운로드 요청</a></li>
                        			<!-- <li><a href="">전송결과</a></li> -->
                        		</ul>
                        	</div>
                        ...
                        <p class="serch_number2 serch_number_left sub_title title2">FTP 서버 파일 목록 <span id="list_count2">2</span>건</p>
...
<!--                         		<p class="file_ll"><input type="checkbox"> Com???</p> -->
                        		<ul class="file_rr">
<!--                         			<li><a href="">FTP연결</a></li> -->
<!--                         			<li><a href="">Download</a></li> -->
									<li><a href="javascript:void(0);" id="btn_schedule">스케줄작성</a></li>
                        			<li><a href="javascript:void(0);" id="btn_upload">Upload</a></li>
<!--                         			<li><a href="">파일삭제</a></li> -->
<!--                         			<li><a href="">폴더생성</a></li> -->
<!--                         			<li><a href="">작업중지</a></li> -->
<!--                         			<li><a href="">스케줄작성</a></li> -->
                        		</ul>
                        	</div>
                        </div>
                    </div>
