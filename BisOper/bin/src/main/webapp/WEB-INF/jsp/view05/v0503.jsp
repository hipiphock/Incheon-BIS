				...
				<section class="serchBox">
                    <table class="top1 v0503">
                         <tr>
							...
							<td><label><input type="checkbox" class="checkBox"> 미사용포함</label></td>
                         </tr>
                    </table>
                	...
                	<div class="contenBox allBody">
                		...
                		<div class="conright v0503Right">
                			<table class="chart">
                				...
                				<tr>
                					<th>노선설명</th>
                					<td colspan="3"><input type="text" class="in317"></td>
                				</tr>
                				<tr>
                					<th>경유정류소수</th>
                        	...
                        	<div class="bottom_btn bottomRight">
                        		<ul class="bottomBtn2">
                        			<li><a href="javascript:void(0);" id="" class="">분기설정</a></li>
                        			<li><a href="javascript:void(0);" id="" class="">수정</a></li><!-- 비활성일 시 disabled 추가, 활성일 시 틀래스 삭제-->
                        		</ul>
                        	</div>
                		</div>
                	</div>  
