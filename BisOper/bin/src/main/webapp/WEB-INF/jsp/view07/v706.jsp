...
<title>통신데이터 관리 - 차량별 수집현황 조회</title>
...
<script src="./js/v07/v706.js"></script>
            ...
            <div class="big_all_body_con">
				...
				<div class="sub_two_serch_body">
                    <div class="two_serch_left">
                    	<span class="ex_706">최대 24시간 조회 ></span>
                        <table class="tong706_serch_top">
                            <tr>
                                <th>조회구분</th>
                                <td width="100px">
                                ...
                                <th>기간</th>
                                <td>
                                	<input type="text" class="in bit_textid text65" id="start_date"> 
                                	<input type="number" min="0" max="23" class="in bit_textid text46 hour_input" id="start_time"> 
                                	~
                                	<input type="text" class="in bit_textid text65" id="end_date"> 
                                	<input type="number" min="0" max="23" class="in bit_textid text46 hour_input" id="end_time">
                                </td>
                                <th>노선번호</th>
                                <td width="100px">
                                ...
                                <td width="130px">
									<select class="in bit_list3 list109" id="event_type">
                                		...
                                		<option value="4">교차로통과건수</option>
                                		<option value="5">평균통신지연시간</option>
                                  	</select>
                                </td>
                                <th style="width:85px;"><label><input type="checkbox" id="min_lag_check">지연시간</label></th>
                                <td width="120px">
                                	<input type="number" class="in bit_textid text37" id="min_lag" value="10" min="7" max="180"> (초)이상
                                </td>
                            </tr>
                        </table>
                    </div>
                ...
                <div class="sistem_conbody">
                    <p class="serch_number" id="search_count">차량별 수집검색 결과</p>
